...
namespace WPad.Business.DTOs
{
    public class Response<T> where T : class
    {
        ...
        {
            return new Response<T> { Data = default, StatusCode = statusCode, SuccesMessage = message, IsSuccessful = true };
        }

        public static Response<T> Success(T data, int statusCode, string message)
        {
            return new Response<T> { Data = data, StatusCode = statusCode, SuccesMessage = message, IsSuccessful = true };
        }
